 ...
 * @endcode
 */
$settings['hash_salt'] = 'nv5tu2TTkVUVR3p6QYJSKgLFHQL26K2bHz3-UQq3wicioOwkJs-BZYy4WrVokHtH7ffQwaeLwg';
...
if (!empty(getenv('REDIS_HOST'))) {
  $redis_endpoint = explode(':', getenv('REDIS_HOST'));
  $settings['redis.connection']['interface'] = 'PhpRedis';
  $settings['redis.connection']['host']      = $redis_endpoint[0];
  $settings['redis.connection']['port']      = $redis_endpoint[1];
